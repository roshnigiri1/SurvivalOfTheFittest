...
public class HerbivoreCompetitionController<K, V> implements Initializable{
    ...
    public void btn(ActionEvent event)
    {
        ...
        try {
            ...
            // HERE WE PUT THE FUNCTION of COMPETITION BETWEEN LARGE HARBIVORES
            //Predation predation=new Predation();
            Model model = new Model();
            model.competitionB(year);

            TreeMap<String, Double> deer = MultiReturnValues.getTreeMap(Model.getnD_Copy()) ;;
            TreeMap<String, Double> horse =  MultiReturnValues.getTreeMap(Model.getnH_Copy());
            TreeMap<String, Double> cattle =  MultiReturnValues.getTreeMap(Model.getnC_Copy());
